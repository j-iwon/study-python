...
# filter(function, interator) 실현해야할때는 필터, 바꿀때는 맵
# 1~10까지 중 짝수만 출력
...
# lambda = url을 /을 기준으로 split 했을때 제일 마지막 부분을 확인한다. 'game'과 같은지 아닌지
# z2.lambda 함수에 해당하는 것을 filter 하여 list로 형변환 후 print
