...
class PartTimer:
    ...
    def calculate_money(self, time, bouns=0):
        total_money = time * PartTimer.pay_of_hour + bouns # total_pay는 지역 변수
        self.total_money += total_money # self.total_pay 필드에서 생성된 변수로 total_pay 와 다름
...
print(result, ryan.nickname, ryan.address)
